...
from dataset_concmean import RSNADatasetTest
...
LOGGER_PATH = "log.txt"
TEST_PATH = os.path.join(DATA_DIR, "stage_2_sample_submission.csv")
ID_COLUMNS = "Image"
...
def main():
    ...
    with timer('preprocessing'):
        ...
        test_dataset = RSNADatasetTest(df, img_size, IMAGE_PATH, id_colname=ID_COLUMNS,
                                    ...
                                    conc_type="concat_all", conc_type2="concat_prepost", n_tta=N_TTA)
